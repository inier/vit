...
import { compatESModuleRequire, createDebug, resolve, winPath, pkgUp, lodash } from '@umijs/utils';
...
export function pathToObj({ type, path, cwd }: { type: PluginType; path: string; cwd: string }) {
  let pkg = null;
